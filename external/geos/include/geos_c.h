...
#define HAVE_GEOS_CAPI_PRECISION_MODEL
...
extern GEOSPrecisionModel GEOS_DLL *GEOSPrecisionModel_create( GEOSPrecisionModelType type );

extern GEOSPrecisionModel GEOS_DLL *GEOSPrecisionModel_createFixed( double scale );

extern void GEOS_DLL GEOSPrecisionModel_destroy( GEOSPrecisionModel* model );


// Does not take ownership of model, model needs to stay valid
extern GEOSGeometryPrecisionReducer GEOS_DLL *GEOSGeometryPrecisionReducer_create( GEOSPrecisionModel* model );

extern GEOSGeometry GEOS_DLL *GEOSGeometryPrecisionReducer_reduce( GEOSGeometryPrecisionReducer* reducer, const GEOSGeometry* geometry );

extern void GEOS_DLL GEOSGeometryPrecisionReducer_destroy( GEOSGeometryPrecisionReducer* reducer );
